...
# ============================================================
data <- read.csv("add dataset path")
head(data)
str(data)
summary(data)
...
# ============================================================
write.csv(data, "cleaned_data path", row.names = FALSE)
...
png("waste_vs_meals.png", width = 800, height = 600)
...
png("waste_vs_temperature.png", width = 800, height = 600)
...
png("event_vs_waste.png", width = 800, height = 600)
...
# 4. Day-wise Waste
png("daywise_waste.png", width = 800, height = 600)
...
# 7. Category vs Waste
png("category_waste.png", width = 800, height = 600)
...
png("monthly_trend.png", width = 900, height = 600)
...
png("prediction_intervals.png", width = 900, height = 600)
...
png("model_comparison.png", width = 800, height = 600)
barplot(
...
png("penalty_sensitivity.png", width = 800, height = 600)
...
png("shortfall_comparison.png", width = 800, height = 600)
barplot(
...
png("hare_vs_baseline_box.png", width = 800, height = 600)
...
png("hare_shap_final.png", width = 1000, height = 800, res = 120)
